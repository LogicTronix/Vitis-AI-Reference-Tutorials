...
def main():
  ...
  model.load_state_dict(torch.load("ResNet152.pth", map_location=torch.device('cpu')))
  ...
  if args.mode == 'train':
    ...
    torch.save(qat_model.state_dict(), "ResNet152_QAT_trained.pth")
    ...
    quantized_model.load_state_dict(torch.load("ResNet152_QAT_trained.pth", map_location=torch.device('cpu')))
